...
public class Tambah_Produk_kasir extends javax.swing.JDialog {

    /**
     * Creates new form TambahProduk
     */
    public Tambah_Produk_kasir(java.awt.Frame parent, boolean modal, String kodeProduk) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tambah_Produk_kasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tambah_Produk_kasir dialog = new Tambah_Produk_kasir(new javax.swing.JFrame(), true, "");

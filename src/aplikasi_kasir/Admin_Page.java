        ...
        txtCariProduk.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                if (isDeleting) {
                    ...
                    try (Connection K = koneksi_database.getConnection(); PreparedStatement P = K.prepareStatement("SELECT * FROM produk " + where)) {
...
//                        function.Log.savelog("\n Product data filtered with key: " + key);
    ...
    private void initComponents() {
        ...
        jButton7.setText("LAPORAN KEUANGAN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(labelUser, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    // 3. Buat objek Laporan_Keuangan_admin dan teruskan objek user
    Laporan_Keuangan_admin laporan = new Laporan_Keuangan_admin(); // Pastikan constructor yang digunakan menerima User
    laporan.setVisible(true);
    this.dispose();
    function.Log.savelog("Navigated to laporan keuangan");
    ...
    private void btnHapusProdukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusProdukActionPerformed
        ...
        if (n != -1) {
            ...
            if (opsi == 0) {
                ...
                try (Connection K = koneksi_database.getConnection(); PreparedStatement S = K.prepareStatement(Q)) {
    ...
    private boolean isNumericColumn(String tableName, String columnName) {
        try (Connection K = koneksi_database.getConnection(); Statement S = K.createStatement(); ResultSet R = S.executeQuery("SELECT DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS "
